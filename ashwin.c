...
#define EXPIRATION_MONTH 12 // December
#define EXPIRATION_DAY 2   // 2nd
...
int main(int argc, char *argv[]) {
    ...
    if (local->tm_year + 1900 > EXPIRATION_YEAR ||
        ...
        printf("Binary is expired dm Ashwin for new one.\n");
        return EXIT_FAILURE;
    }

    printf("Running, Binary by Ashwin\n");
    ...
    printf("Attack finished. Binary by Ashwin\n");
    return 0;
}
